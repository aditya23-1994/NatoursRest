...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  if (!currentUser) {
    return next(
      new AppError("The user Belonging to the token doesn't exists", 401)
    );
  }
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  const message = `Forgot your password? Submit your patch request with your new password
  and passwordConfirm to: ${resetURL}.\nIf you didn't forgot please ignore.`;
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  user.passwordResetExpires = undefined;
  await user.save();
  //3) Update changedPasswordAt property from the user.
